...
#ifndef __RULP_XIMPL_RUNTIME_ABS_REF_CALLABLE_ADAPTER_H_
#define __RULP_XIMPL_RUNTIME_ABS_REF_CALLABLE_ADAPTER_H_
#include "rulp/runtime/IRCallable.h"
#include "rulp/object/AbsRefObject.h"
namespace lfc {

class AbsRefCallableAdapter 
  : public AbsRefObject
  , virtual public IRCallable
{

public:
  AbsRefCallableAdapter();
  virtual ~AbsRefCallableAdapter();
...
#endif //__RULP_XIMPL_RUNTIME_ABS_REF_CALLABLE_ADAPTER_H_