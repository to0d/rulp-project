...
TEST(base_function, test_bind_mf)
{
  __ctest_inner_function::__inner_class2 tmpObj;
  ...
  { 
    ...
    f = bind(&__ctest_inner_function::__inner_class2::fun0,&tmpObj);
    EXPECT_TRUE(f != NULL);
    EXPECT_EQ(f(),0);
  }
  ...
  //f1
  {
    ...
    f = bind(&__ctest_inner_function::__inner_class2::fun1,&tmpObj, _1);
    EXPECT_TRUE(f != NULL);
    EXPECT_EQ(f(1),1);
  ...
  //f2
  {
    ...
    f = bind(&__ctest_inner_function::__inner_class2::fun2,&tmpObj,_1,_2);
    EXPECT_TRUE(f != NULL);
    EXPECT_EQ(f(1,1),2);
  ...
  //f3
  {
    ...
    f = bind(&__ctest_inner_function::__inner_class2::fun3,&tmpObj,_1,_2,_3);
    EXPECT_TRUE(f != NULL);
    EXPECT_EQ(f(0,0,0),3);
  ...
  //f4
  {
    ...
    f = bind(&__ctest_inner_function::__inner_class2::fun4,&tmpObj,_1,_2,_3,_4);
    EXPECT_TRUE(f != NULL);
  ...
  //f5
  {
    ...
    f = bind(&__ctest_inner_function::__inner_class2::fun5,&tmpObj,_1,_2,_3,_4,_5);
    EXPECT_TRUE(f != NULL);
  ...
  //f6
  {
    ...
    f = bind(&__ctest_inner_function::__inner_class2::fun6,&tmpObj,_1,_2,_3,_4,_5,_6);
    EXPECT_TRUE(f != NULL);
  ...
  //f7
  {
    ...
    f = bind(&__ctest_inner_function::__inner_class2::fun7,&tmpObj,_1,_2,_3,_4,_5,_6,_7);
    EXPECT_TRUE(f != NULL);
  ...
  //f8
  {
    ...
    f = bind(&__ctest_inner_function::__inner_class2::fun8,&tmpObj,_1,_2,_3,_4,_5,_6,_7,_8);
    EXPECT_TRUE(f != NULL);
...
// 		f = bind(&__ctest_inner_function::__inner_class2::fun9,&tmpObj,_1,_2,_3,_4,_5,_6,_7,_8,_9);
// 		EXPECT_TRUE(f != NULL);
